...
RUN apt-get update && apt install -y asterisk asterisk-core-sounds-es-gsm php-cli php-pgsql asterisk-prompt-es && apt-get clean

ADD *.conf /etc/asterisk/
ADD *.php /usr/share/asterisk/agi-bin/
